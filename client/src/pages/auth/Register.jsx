    ...
    <div className="bg-[#f9f9f9] text-[#1a1c1c] min-h-screen flex flex-col font-body">
      <header className="fixed top-0 w-full z-50 glass-effect">
        <div className="flex justify-between items-center px-8 py-6 w-full max-w-7xl mx-auto">
          <div className="text-2xl font-bold italic text-[#8f0020] font-headline tracking-tight">
            Minori
          </div>
          <Link
            to="/login"
            className="text-sm font-label font-medium text-[#635d5a] hover:text-[#8f0020] transition-colors"
          >
          ...
          <div className="lg:col-span-5 space-y-8 order-2 lg:order-1">
            <div className="space-y-4">
              ...
              <p className="text-lg text-[#635d5a] font-body max-w-md leading-relaxed">
                Bước vào một võ đường kỹ thuật số hiện đại được thiết kế để mang lại sự rõ ràng và
                tập trung sâu sắc. Tham gia cộng đồng những người học tận tâm.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 gap-6">
              <div className="p-6 rounded-xl bg-[#f3f3f3] flex items-start gap-4 transition-transform hover:scale-[1.02] duration-300">
                <div className="w-12 h-12 rounded-full bg-[#8f0020]/10 flex items-center justify-center flex-shrink-0">
                  <span className="material-symbols-outlined text-[#8f0020]" data-icon="insights">
                    insights
                  </span>
                </div>
                <div>
                  <h3 className="font-headline font-bold text-[#1a1c1c]">theo dõi tiến độ</h3>
                  <p className="text-sm text-[#5c403f] font-body">
                    Hình ảnh hóa hành trình của bạn với phân tích chi tiết và Vòng tròn Tiến độ.
                  </p>
                </div>
              </div>
              ...
              <div className="p-6 rounded-xl bg-[#f3f3f3] flex items-start gap-4 transition-transform hover:scale-[1.02] duration-300">
                <div className="w-12 h-12 rounded-full bg-[#004c5c]/10 flex items-center justify-center flex-shrink-0">
                  <span
                    className="material-symbols-outlined text-[#004c5c]"
                ...
                <div>
                  ...
                  <p className="text-sm text-[#5c403f] font-body">
                    Quản lý thư viện tài liệu học tập và các bộ từ vựng cá nhân của bạn.
                  </p>
                </div>
              </div>
              ...
              <div className="p-6 rounded-xl bg-[#f3f3f3] flex items-start gap-4 transition-transform hover:scale-[1.02] duration-300">
                <div className="w-12 h-12 rounded-full bg-[#635d5a]/10 flex items-center justify-center flex-shrink-0">
                  <span className="material-symbols-outlined text-[#635d5a]" data-icon="groups">
                    groups
                  </span>
                </div>
                <div>
                  ...
                  <p className="text-sm text-[#5c403f] font-body">
                    Chia sẻ kiến thức, đặt câu hỏi và leo lên bảng xếp hạng toàn cầu.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="lg:col-span-7 order-1 lg:order-2">
            <div className="bg-[#ffffff] p-8 md:p-12 rounded-[24px] shadow-[0_12px_32px_rgba(26,28,28,0.04)] relative overflow-hidden">
              ...
              <div className="relative z-10">
                <h2 className="font-headline text-3xl font-bold text-[#1a1c1c] mb-8">
                  Tạo hồ sơ của bạn
                </h2>
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="flex flex-col gap-2">
                      <label className="text-xs font-label font-bold uppercase tracking-widest text-[#635d5a] ml-1">
                        TÊN ĐĂNG NHẬP
                      </label>
                      <input
                        name="username"
                  ...
                  <div className="flex items-center gap-3 py-2">
                    ...
                    />
                    <label
                      className="text-sm text-[#5c403f] font-body leading-tight"
                      htmlFor="terms"
                    >
                      Tôi đồng ý với{' '}
                      <a
                        className="text-[#8f0020] underline underline-offset-4 hover:text-[#920021] transition-colors"
                        href="#"
                      >
                        Điều khoản Dịch vụ
                      </a>{' '}
                ...
                <div className="mt-8 pt-8 border-t border-[#eeeeee] flex flex-col md:flex-row items-center justify-between gap-4">
                  ...
                  <div className="flex gap-4 w-full md:w-auto">
                    <button
                      ...
                      className="flex-1 md:flex-none flex items-center justify-center gap-2 px-6 py-2.5 rounded-lg bg-[#e8e8e8] hover:bg-[#e2e2e2] transition-colors font-label font-medium text-sm text-[#1a1c1c] cursor-pointer"
                    >
                    ...
                    <button
                      type="button"
                      className="flex-1 md:flex-none flex items-center justify-center gap-2 px-6 py-2.5 rounded-lg bg-[#e8e8e8] hover:bg-[#e2e2e2] transition-colors font-label font-medium text-sm text-[#1a1c1c]"
                    >
      ...
      <footer className="w-full border-t border-[#e4e4e7] bg-[#f4f4f5] mt-auto">
        <div className="flex flex-col md:flex-row justify-between items-center p-8 max-w-7xl mx-auto font-manrope text-sm">
          ...
          <div className="flex gap-8">
            <a className="text-[#71717a] hover:text-[#27272a] transition-opacity" href="#">
              Điều khoản Dịch vụ
            </a>
            <a className="text-[#71717a] hover:text-[#27272a] transition-opacity" href="#">
              Chính sách Bảo mật
