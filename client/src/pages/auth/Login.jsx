    ...
    <div className="bg-[#f9f9f9] text-[#1a1c1c] font-body selection:bg-[#ffdad9] selection:text-[#400009] min-h-screen flex flex-col japanese-pattern">
          ...
          <div className="relative z-10 bg-[#ffffff] rounded-xl shadow-[0_12px_32px_rgba(26,28,28,0.06)] overflow-hidden ring-1 ring-black/5">
            <div className="p-8 md:p-12">
              ...
              <div className="mb-10 text-center md:text-left">
                <h1 className="text-3xl font-headline font-bold italic text-[#8f0020] tracking-tight mb-2">
                  Minori
                </h1>
                <p className="text-[#5c403f] text-sm font-medium">
                  Quay lại hành trình đắm mình của bạn.
                </p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="group">
                    <label
                      className="block text-xs font-label font-bold uppercase tracking-widest text-[#635d5a] mb-2 ml-1 group-focus-within:text-[#8f0020] transition-colors"
                      htmlFor="username"
                    >
                      Tên đăng nhập
                    </label>
                  ...
                  <div className="group">
                    <div className="flex justify-between items-center mb-1 px-1">
                      <label
                        className="block text-xs font-label font-semibold text-[#5c403f] uppercase tracking-wider"
                        htmlFor="password"
                      >
                        Mật khẩu
                      </label>
                      <Link
                        className="text-xs font-semibold text-[#8f0020] hover:text-[#920021] transition-colors"
                        to="/forgot-password"
                      >
                        Quên mật khẩu?
                      </Link>
                ...
                <div className="flex items-center py-2">
                  ...
                  />
                  <label
                    className="ml-3 block text-sm text-[#5c403f] font-medium select-none cursor-pointer"
                    htmlFor="remember-me"
                  >
                    Ghi nhớ đăng nhập
                  </label>
              ...
              <div className="grid grid-cols-2 gap-4">
                <button
                  ...
                  type="button"
                  className="flex items-center justify-center gap-3 bg-[#f3f3f3] hover:bg-[#e8e8e8] text-[#1a1c1c] font-semibold py-3 px-4 rounded-lg transition-all duration-200 group cursor-pointer"
                >
                ...
                <button className="flex items-center justify-center gap-3 bg-[#f3f3f3] hover:bg-[#e8e8e8] text-[#1a1c1c] font-semibold py-3 px-4 rounded-lg transition-all duration-200 group">
                  <span className="w-5 h-5 flex items-center justify-center">
                    <svg className="w-full h-full" viewBox="0 0 24 24">
                      <path
                        d="M17.05 20.28c-.96.95-2.04 1.44-3.23 1.44-1.2 0-2.2-.44-3.03-1.32-1.03-.94-1.92-1.42-2.68-1.42-.76 0-1.74.52-2.95 1.55-1.2 1.03-2.3 1.55-3.28 1.55-.98 0-1.85-.34-2.63-1.02-.78-.68-1.17-1.53-1.17-2.55 0-1.02.4-2.06 1.2-3.12l.25-.33c1.33-1.7 2.85-2.55 4.55-2.55.9 0 1.77.3 2.62.9 1.1.77 1.95 1.15 2.53 1.15.58 0 1.4-.38 2.45-1.15.85-.6 1.72-.9 2.62-.9 1.43 0 2.65.6 3.65 1.8.1.1.2.22.3.35-2.3 1.35-3.45 3.32-3.45 5.92 0 2 1.05 3.73 3.15 5.2-.23.5-.53 1-.9 1.52zm-3.03-16.1c0 1.2-.43 2.3-1.28 3.32-.85 1.02-1.87 1.63-3.05 1.82-.1.03-.2.05-.3.05-.07 0-.13 0-.2-.02.03-2.33 1.12-4.22 3.25-5.68.07-.05.13-.08.2-.1.1-.03.22-.05.35-.05 1.2 0 2.24.88 3.13 2.66z"
                        fill="currentColor"
                      ></path>
                    </svg>
                  </span>
              ...
              <div className="mt-12 text-center">
                <p className="text-sm text-[#5c403f] font-medium">
                  Mới tham gia?{' '}
                  <Link
                    className="text-[#8f0020] font-bold hover:underline underline-offset-4 decoration-2 transition-all"
                    to="/register"
                  >
                    Tạo tài khoản
                  </Link>
          ...
          <div className="hidden lg:block absolute -right-64 top-1/2 -translate-y-1/2 w-56 transform rotate-3 scale-110 pointer-events-none">
            <div className="bg-[#ffffff] p-6 rounded-xl shadow-xl border border-[#e4bdbc]/10">
              <div className="flex flex-col gap-1">
                ...
                <span className="text-xs font-label font-bold text-[#004c5c] uppercase tracking-tighter">
                  Manabi
                </span>
                <div className="h-[1px] w-8 bg-[#e4bdbc]/30 my-2"></div>
                <span className="text-sm text-[#1a1c1c] font-medium italic">
                  học tập; nghiên cứu
                </span>
              </div>
            </div>
      ...
      <footer className="w-full border-t border-zinc-200 bg-zinc-100 flex flex-col md:flex-row justify-between items-center p-8 mt-auto font-manrope text-sm">
        <div className="flex gap-6 mb-4 md:mb-0">
          <a className="text-zinc-500 hover:text-zinc-800 transition-opacity" href="#">
            Điều khoản dịch vụ
          </a>
          <a className="text-zinc-500 hover:text-zinc-800 transition-opacity" href="#">
            Chính sách bảo mật
          ...
          <a className="text-zinc-500 hover:text-zinc-800 transition-opacity" href="#">
            © 2024 Minori Immersion Hub. Chế tác bởi Zen.
          </a>
        </div>
