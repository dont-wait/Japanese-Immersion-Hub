      ...
      {!isSuccess && (
        <main className="w-full max-w-xl flex flex-col items-center">
          ...
          <div className="mb-12 text-center">
            <h1 className="font-headline text-4xl font-extrabold italic text-[#8f0020] tracking-tight mb-2">
              Minori
            </h1>
            <p className="font-label text-sm text-[#635d5a] uppercase tracking-widest">
              Modern Dojo
            </p>
          </div>
          ...
          <div className="w-full bg-[#ffffff] rounded-xl editorial-shadow p-8 md:p-12 relative overflow-hidden">
            ...
            <div className="absolute -top-12 -right-12 opacity-5 pointer-events-none">
              <span className="font-headline text-[180px] font-extrabold italic leading-none select-none">
                道
              </span>
            </div>
            ...
            <div className="relative z-10">
              <div className="mb-8">
                <h2 className="font-headline text-3xl font-bold tracking-tight text-[#1a1c1c] mb-3">
                  Quên mật khẩu?
                </h2>
                <p className="text-[#635d5a] leading-relaxed">
                  Nhập địa chỉ email được liên kết với tài khoản của bạn. Chúng tôi sẽ gửi cho bạn
                  một liên kết an toàn để đặt lại con đường của bạn thông qua võ đường hiện đại.
                </p>
              </div>
              ...
              <form className="space-y-8" onSubmit={handleSubmit}>
                <div className="space-y-2">
                  <label
                    className="font-label text-sm font-medium text-[#5c403f] ml-1"
                    htmlFor="email"
                  >
                    Địa chỉ Email
                  </label>
            ...
            <div className="mt-10 pt-8 border-t border-[#e4bdbc]/15 flex justify-center">
              <Link
                to="/login"
                className="flex items-center gap-2 font-label text-sm font-medium text-[#635d5a] hover:text-[#8f0020] transition-colors group"
              >
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-lg">
            <div className="p-6 bg-[#004c5c]/5 rounded-xl">
              ...
              <p className="text-sm text-[#635d5a] leading-relaxed">
                Liên kết đặt lại sẽ hết hạn sau 24 giờ để đảm bảo tiến trình của bạn luôn được bảo
                vệ.
              </p>
            </div>
            <div className="p-6 bg-[#635d5a]/5 rounded-xl">
              ...
              <p className="text-sm text-[#635d5a] leading-relaxed">
                Không thể truy cập email? Hãy liên hệ với sensei hỗ trợ của chúng tôi để được giúp
                đỡ.
              </p>
            </div>
          </div>
        ...
        <div className="fixed inset-0 bg-[#f9f9f9]/95 backdrop-blur-xl z-[100] flex flex-col items-center justify-center p-6 text-center animate-fade-in">
          <div className="relative mb-8">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <span
                className="material-symbols-outlined text-4xl text-[#8f0020]"
          ...
          <h2 className="font-headline text-3xl font-extrabold text-[#1a1c1c] mb-4">
            Con đường đã được khôi phục
          </h2>
          <p className="max-w-md text-[#635d5a] leading-relaxed mb-8">
            Một liên kết khôi phục đã được gửi đến hộp thư đến của bạn. Kiểm tra thư và làm theo
            hướng dẫn để tiếp tục hành trình.
          </p>
          <Link
            to="/login"
            className="px-8 py-3 bg-[#e2e2e2] text-[#1a1c1c] font-headline font-bold rounded-xl hover:scale-105 transition-all"
          >
            Quay lại Võ đường
          </Link>
        </div>
      ...
      {!isSuccess && (
        <footer className="mt-20 w-full max-w-4xl flex flex-col md:flex-row justify-between items-center p-8 border-t border-zinc-200 gap-6 opacity-60 hover:opacity-100 transition-opacity">
          <span className="font-body text-sm text-zinc-500">
            © 2024 Minori Immersion Hub. Chế tác với Zen.
          </span>
          <div className="flex gap-8">
            <a
              className="font-body text-sm text-zinc-500 hover:text-[#8f0020] transition-colors"
              href="#"
            >
              Điều khoản Dịch vụ
            </a>
