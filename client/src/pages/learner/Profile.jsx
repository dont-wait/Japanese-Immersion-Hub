...
import { Key, User, Mail, Shield, AlertCircle, ChevronRight, Camera, Settings, Bell, Lock } from 'lucide-react';
                    ...
                    <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                        <div>
                            ...
                            <p className="text-zinc-500 font-medium max-w-md">
                                Quản lý thông tin định danh và các thiết lập bảo mật cấp cao cho tài khoản Minori của bạn.
                            </p>
                        </div>
                        <div className="flex gap-3">
                            <Button variant="secondary" className="rounded-2xl h-12 px-6 font-bold border-zinc-100 text-zinc-600 bg-white shadow-sm">
                    ...
                    <div className="bg-white rounded-[2.5rem] p-8 shadow-sm border border-zinc-100 flex flex-col items-center relative overflow-hidden group">
                        <div className="w-32 h-32 rounded-[2rem] bg-paper relative mb-6 p-1 shadow-inner border border-zinc-50">
                            <div className="w-full h-full rounded-[1.8rem] bg-fuji/5 flex items-center justify-center text-fuji text-5xl font-black overflow-hidden border-2 border-white">
                                {user?.picture ? (
                                    <img src={user.picture} alt={user.username} className="w-full h-full object-cover transition-transform group-hover:scale-110 duration-500" />
                                ) : (
                        ...
                        <div className="text-center space-y-1">
                            <h2 className="text-2xl font-black font-headline text-ink">{user?.displayName || user?.username}</h2>
                        ...
                        <div className="w-full mt-10 space-y-3">
                            <div className="flex items-center gap-4 p-4 rounded-2xl bg-paper/50 border border-zinc-50">
                                ...
                                <div className="overflow-hidden">
                                    <p className="text-[10px] font-black uppercase tracking-wider text-zinc-400 mb-0.5">Email Address</p>
                            ...
                            <div className="flex items-center gap-4 p-4 rounded-2xl bg-paper/50 border border-zinc-50">
                                ...
                                <div className="overflow-hidden">
                                    <p className="text-[10px] font-black uppercase tracking-wider text-zinc-400 mb-0.5">Username</p>
                        ...
                        {!user?.hasPassword ? (
                            <div className="bg-gradient-to-br from-amber-50/50 to-orange-50/50 border border-amber-200/40 rounded-[2rem] p-8 mb-8 relative overflow-hidden">
                                ...
                                <div className="flex flex-col md:flex-row items-center gap-8">
                                    ...
                                    <div className="flex-1 text-center md:text-left">
                                        <h4 className="text-xl font-black text-amber-900 mb-2 tracking-tight">Thiết lập mật khẩu Minori</h4>
                                        <p className="text-sm text-amber-800/60 font-medium leading-relaxed mb-6">
                                            Bạn đang đăng nhập qua Google. Hãy tạo mật khẩu riêng để có thể đăng nhập linh hoạt hơn trên mọi thiết bị mà không cần phụ thuộc vào bên thứ ba.
                                        </p>
                                        <Button 
                            ...
                            <div className="bg-green-50/50 border border-green-100 rounded-[2rem] p-8 mb-8">
                                <div className="flex items-center gap-6">
                                    ...
                                    <div>
                                        <h4 className="text-xl font-black text-green-900 mb-1 tracking-tight">Mật khẩu đã được thiết lập</h4>
                                        <p className="text-sm text-green-800/60 font-medium">
                                            Bạn đã có thể đăng nhập bằng cả Email/Mật khẩu hoặc Google. Tài khoản của bạn đang được bảo mật tốt.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="p-6 rounded-[1.5rem] border border-zinc-100 bg-paper/20 flex justify-between items-center hover:border-fuji/30 hover:bg-fuji/[0.02] transition-all cursor-pointer group">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-[10px] font-bold text-zinc-400 uppercase tracking-wider">Cập nhật định kỳ</p>
                                    </div>
                                </div>
                                <ChevronRight size={18} className="text-zinc-300 group-hover:text-fuji transition-transform group-hover:translate-x-1" />
                            </div>
                            ...
                            <div className="p-6 rounded-[1.5rem] border border-zinc-100 bg-paper/20 flex justify-between items-center hover:border-fuji/30 hover:bg-fuji/[0.02] transition-all cursor-pointer group">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-[10px] font-bold text-zinc-400 uppercase tracking-wider">Các thiết bị đang dùng</p>
                                    </div>
                                </div>
                                <ChevronRight size={18} className="text-zinc-300 group-hover:text-fuji transition-transform group-hover:translate-x-1" />
                            </div>
            ...
            >
                <div className="py-4">
                    <div className="text-center space-y-3 mb-10">
                        ...
                        <h4 className="text-3xl font-black font-headline text-ink tracking-tight">Tạo mật khẩu.</h4>
                    ...
                    <form onSubmit={handleCreatePassword} className="space-y-6">
                        <div className="space-y-2">
                            <label className="text-xs font-black text-ink uppercase tracking-widest ml-1">Mật khẩu mới</label>
