...
export default function DailyGoalCard({ target = 50, current = 0 }) {
    ...
    return (
        <div className={`p-5 rounded-2xl border transition-all ${completed
            ...
            <div className="w-full h-2.5 rounded-full bg-gray-200 dark:bg-gray-700 overflow-hidden">
                <div
                    className={`h-full rounded-full transition-all duration-500 ease-out ${completed
                            ? 'bg-green-500'
                            : 'bg-gradient-to-r from-[#8B5CF6] to-[#DB2777]'
                        }`}
